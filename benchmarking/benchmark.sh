...
./benchmark_queries kestrel.k31.freqskmers.fa.ust.fa 6 3 100000 \
    > logs/kestrel_k6.log 2>&1 &

./benchmark_queries cod.k31.freqskmers.fa.ust.fa 6 3 100000 \
    > logs/cod_k6.log 2>&1 &

./benchmark_queries human.k31.freqskmers.fa.ust.fa 6 3 100000 \
    > logs/human_k6.log 2>&1 &

wait

./benchmark_queries kestrel.k31.freqskmers.fa.ust.fa 11 3 100000 \
    > logs/kestrel_k11.log 2>&1 &

./benchmark_queries cod.k31.freqskmers.fa.ust.fa 11 3 100000 \
    > logs/cod_k11.log 2>&1 &

./benchmark_queries human.k31.freqskmers.fa.ust.fa 11 3 100000 \
    > logs/human_k11.log 2>&1 &

wait

./benchmark_queries kestrel.k31.freqskmers.fa.ust.fa 21 3 100000 \
    > logs/kestrel_k21.log 2>&1 &

./benchmark_queries cod.k31.freqskmers.fa.ust.fa 21 3 100000 \
    > logs/cod_k21.log 2>&1 &

./benchmark_queries human.k31.freqskmers.fa.ust.fa 21 3 100000 \
